...
#define SENSOR_DEFAULT_DELAY            (100)   /* 200 ms */
...
hwm_sensor_data osensor_data_kernel; 
/*----------------------------------------------------------------------------*/
		...
		case SENSOR_GET_DATA:
			...
			else
			{
			    ...
			    osensor_data->status = input_abs_get_val(input_data, ABS_STATUS);
                        ...
                        osensor_data_kernel.values[0] = osensor_data->values[0]; 
                        osensor_data_kernel.values[1] = osensor_data->values[1]; 
                        osensor_data_kernel.values[2] = osensor_data->values[2]; 
                        osensor_data_kernel.status = osensor_data->status; 						
			}
