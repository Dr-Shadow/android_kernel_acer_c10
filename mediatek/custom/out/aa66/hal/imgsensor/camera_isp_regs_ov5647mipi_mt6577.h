...
Shading:{
    {set:{//00 Preview
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0x903F902F,0x00581920,0x00430036,0x20202020,
    }},
    {set:{//01 Capture
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0xF04FF03B,0x00000000,0x00510042,0x20202020,
    }},
    {set:{//02
...
NR1:{
    {set:{//00 Preview ISO100
        0x000002E7, 0x00001178, 0x092328C8, 0x0000089C, 0x02030507, 0x080A0B0D, 0x01030506, 
        0x08090A0C, 0x01030506, 0x08090A0C, 0x01030506, 0x08090A0C, 0x0206090D, 0x10101010, 
    }},
    {set:{//01 Preview ISO200
        0x00000227, 0x00000178, 0x092328C8, 0x0000089C, 0x02050708, 0x0A0B0C0E, 0x02050708, 
        0x0A0B0C0E, 0x02050708, 0x0A0B0C0E, 0x02050708, 0x0A0B0D0E, 0x0206090D, 0x10101010, 
    }},
    {set:{//02 Preview ISO400
        0x000002E7, 0x000011A0, 0x092E28C8, 0x0000089C, 0x03090C0E, 0x11141619, 0x04090C0D, 
    ...
    {set:{//04 Preview ISO1600
        0x000002E7, 0x000011A0, 0x092E28C8, 0x0000089C, 0x04090C0E, 0x10121315, 0x04090C0E, 
...
EE:{//EE
    {set:{//00 Preview ISO100 (middle sharpness)
        0x00000028, 0x0028282D, 0x00380122, 0x026D0B54, 0x0327047C, 0x003C00A4, 0xFFFFFD0D, 
    }},
    {set:{//01 Preview ISO200 (middle sharpness)
        0x00000028, 0x0028282D, 0x00270031, 0x01ED0963, 0x0280038B, 0x003200B3, 0xFFFFFD0D, 
    }},
    {set:{//02 Preview ISO400 (middle sharpness)
        0x00000028, 0x0028282D, 0x0012004B, 0x0140067D, 0x01A002A5, 0x001E00CD, 0xFFFFFD0D, 
    }},
    {set:{//03 Preview ISO800 (middle sharpness)
        0x00000024, 0x00282821, 0x00110050, 0x012D0582, 0x018702AA, 0x001400D2, 0xFFFFFD0D, 
    }},
    {set:{//04 Preview ISO1600 (middle sharpness)
        0x00000024, 0x00282821, 0x00110056, 0x01190588, 0x016D02B0, 0x000A00D8, 0xFFFFFC0D, 
    }},
    {set:{//05 Capture ISO100 (middle sharpness)
        0x00000028, 0x0037372D, 0x00380122, 0x026D0B54, 0x0327047C, 0x003C00A4, 0xFFFFFD0D, 
    }},
    {set:{//06 Capture ISO200 (middle sharpness)
        0x00000028, 0x0037372D, 0x00270031, 0x01ED0963, 0x0280038B, 0x003200B3, 0xFFFFFD0D, 
    }},
    {set:{//07 Capture ISO400 (middle sharpness)
        0x00000026, 0x0037372D, 0x0012004B, 0x0140067D, 0x01A002A5, 0x002800CD, 0xFFFFFD0D, 
    }},
    {set:{//08 Capture ISO800 (middle sharpness)
        0x00000024, 0x0037372D, 0x00110050, 0x012D0582, 0x018702AA, 0x001400D2, 0xFFFFFD0D, 
    }},
    {set:{//09 Capture ISO1600 (middle sharpness)
        0x00000024, 0x0037372D, 0x00110056, 0x01190588, 0x016D02B0, 0x000A00D8, 0xFFFFFC0D, 
    }},
    {set:{//10  no one uses this, this is Min EE (low sharpness)
        0x00000024, 0x0037372D, 0x00050023, 0x012C0B3C, 0x019000D0, 0x000A00E7, 0xFFFF0005, 
    }},
    {set:{//11 no one uses this, this is Max EE (high sharpness)
        0x0000002C, 0x00373721, 0x003C0123, 0x03202537, 0x03E801D0, 0x003C00E7, 0xFFFF0005, 
    }}
}, 
Saturation:{
    ...
    {set:{//05 no one uses this, this is Min Sat. (low saturation)
        0x00000709, 0x1020E0F0, 0x203C403C, 0x22000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//06 no one uses this, this is Max Sat. (high saturation)
        0x00000709, 0x1020E0F0, 0x2E6A6E6A, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }}
}, 
Contrast:{
    //..........................................................................
...
CCM:{
    {set:{//00
        0x01E404DA, 0x040A0423, 0x011E0005, 0x001704B1, 0x019A0000, 
    }},
    {set:{//01
