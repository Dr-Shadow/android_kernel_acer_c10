...
void cci_hw_id_pin_init()
{
    mt_set_gpio_mode(GPIO_HW_ID_1, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID_1, GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_HW_ID_1, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID_2, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID_2, GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_HW_ID_2, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID_3, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID_3, GPIO_DIR_IN);
    mt_set_gpio_pull_enable(GPIO_HW_ID_3, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID_4, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID_4, GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_HW_ID_4, GPIO_PULL_DISABLE);
    mt_set_gpio_mode(GPIO_HW_ID_5, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_HW_ID_5, GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_HW_ID_5, GPIO_PULL_DISABLE);
    GPIOLOG("*************************************************************\n");
    GPIOLOG("*    HW ID PIN init function                                *\n");
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID_1,mt_get_gpio_mode(GPIO_HW_ID_1),mt_get_gpio_dir(GPIO_HW_ID_1),mt_get_gpio_pull_enable(GPIO_HW_ID_1));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID_2,mt_get_gpio_mode(GPIO_HW_ID_2),mt_get_gpio_dir(GPIO_HW_ID_2),mt_get_gpio_pull_enable(GPIO_HW_ID_2));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID_3,mt_get_gpio_mode(GPIO_HW_ID_3),mt_get_gpio_dir(GPIO_HW_ID_3),mt_get_gpio_pull_enable(GPIO_HW_ID_3));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID_4,mt_get_gpio_mode(GPIO_HW_ID_4),mt_get_gpio_dir(GPIO_HW_ID_4),mt_get_gpio_pull_enable(GPIO_HW_ID_4));
    GPIOLOG("*    HW ID pin = %d, Mode = %d, DIR = %d, Pull= %d          *\n",GPIO_HW_ID_5,mt_get_gpio_mode(GPIO_HW_ID_5),mt_get_gpio_dir(GPIO_HW_ID_5),mt_get_gpio_pull_enable(GPIO_HW_ID_5));
    GPIOLOG("*************************************************************\n");
    return 0;
}