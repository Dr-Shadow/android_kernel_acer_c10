...
// ----------------------------------------------------------------------------
// AudioYusuPolicyManager implements audio policy manager behavior common to all platforms.
// Each platform must implement an AudioPolicyManager class derived from AudioYusuPolicyManager
// and override methods for which the platform specific behavior differs from the implementation
// in AudioYusuPolicyManager. Even if no specific behavior is required, the AudioPolicyManager
...
class AudioYusuPolicyManager: public AudioPolicyInterface
...
public:
                AudioYusuPolicyManager(AudioPolicyClientInterface *clientInterface);
        virtual ~AudioYusuPolicyManager();
...
protected:
        ...
        static const VolumeCurvePoint sDefaultVolumeCurve[AudioYusuPolicyManager::VOLCNT];
        // default volume curve for media strategy
        static const VolumeCurvePoint sDefaultMediaVolumeCurve[AudioYusuPolicyManager::VOLCNT];
        // volume curve for media strategy on speakers
        static const VolumeCurvePoint sSpeakerMediaVolumeCurve[AudioYusuPolicyManager::VOLCNT];
        // volume curve for sonification strategy on speakers
        static const VolumeCurvePoint sSpeakerSonificationVolumeCurve[AudioYusuPolicyManager::VOLCNT];
        static const VolumeCurvePoint sDefaultSystemVolumeCurve[AudioYusuPolicyManager::VOLCNT];
        static const VolumeCurvePoint sHeadsetSystemVolumeCurve[AudioYusuPolicyManager::VOLCNT];
...
public:
	...
	float computeCustomVolume(int stream, float &vol);
