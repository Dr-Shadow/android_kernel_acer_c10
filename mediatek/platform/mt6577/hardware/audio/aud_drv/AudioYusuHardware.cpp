...
status_t AudioYusuHardware::doModeRouting()
{
    ...
    if(mMode == 1 && mDevice == 2){
        LOG_HARDWARE("************setParameters Need re-apply gain******************");
        mVolumeController->setMasterVolume(mVolumeController->getMasterVolume(),mMode,mDevice);
    }
...
status_t AudioYusuHardware::doOutputDeviceRouting(bool checkPredevice, bool checknowDevice)
{
    ...
    case android_audio_legacy::AudioSystem::MODE_RINGTONE:
    {
        ...
        case android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_SCO_CARKIT:
        {
            LOG_HARDWARE("close, N/R, BLUETOOTH_SCO ");
            pLad->LAD_SetSpeechMode(SPH_MODE_NORMAL);
            mStreamHandler->RestoreOutputStream();       //ccc skype
            break;
        }
        case android_audio_legacy::AudioSystem::DEVICE_OUT_SPEAKER:
        {
...
bool AudioYusuHardware::SetForceUse(uint32_t usage,uint32_t config)
{
    ...
    case android_audio_legacy::AudioSystem::FOR_COMMUNICATION:
    {
        ...
        mOuputForceuse[android_audio_legacy::AudioSystem::MODE_NORMAL] = config;  //ccc skype
...
status_t  AudioYusuHardware::setParameters(const String8& keyValuePairs)
{
    ...
    {
        LOG_HARDWARE("setParameters addoutputdeviceNew=0x%x, hp=0x%x", value, android_audio_legacy::AudioSystem::DEVICE_OUT_WIRED_HEADPHONE);
        param.remove(key1);
        ...
        if(value == android_audio_legacy::AudioSystem::DEVICE_OUT_WIRED_HEADPHONE ||
            value == android_audio_legacy::AudioSystem::DEVICE_OUT_WIRED_HEADSET||
            value == android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_SCO||
            value == android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_SCO_HEADSET||
            value == android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_SCO_CARKIT||
            value == android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_A2DP){
            LOG_HARDWARE("setParameters addoutputdeviceNew");
            if(mMode == 1 && mDevice == 2){
                LOG_HARDWARE("************setParameters Need re-apply gain******************");
                mVolumeController->setMasterVolume(mVolumeController->getMasterVolume(),mMode,mDevice);
            }
    ...
    {
        LOG_HARDWARE("setParameters RemoveoutputdeviceNew=0x%x", value);
        param.remove(key2);
...
bool AudioYusuHardware::IsHeadsetBTConnect()
{
    ALOGD("IsHeadsetBTConnect mOutputAvailable[MODE_NORMAL] = %d",mOutputAvailable[android_audio_legacy::AudioSystem::MODE_NORMAL]);
    return  (mOutputAvailable[android_audio_legacy::AudioSystem::MODE_NORMAL]&android_audio_legacy::AudioSystem::DEVICE_OUT_WIRED_HEADPHONE)||
            (mOutputAvailable[android_audio_legacy::AudioSystem::MODE_NORMAL]&android_audio_legacy::AudioSystem::DEVICE_OUT_WIRED_HEADSET)||
            (mOutputAvailable[android_audio_legacy::AudioSystem::MODE_NORMAL]&android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_SCO)||
            (mOutputAvailable[android_audio_legacy::AudioSystem::MODE_NORMAL]&android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_SCO_HEADSET)||
            (mOutputAvailable[android_audio_legacy::AudioSystem::MODE_NORMAL]&android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_SCO_CARKIT)||
            (mOutputAvailable[android_audio_legacy::AudioSystem::MODE_NORMAL]&android_audio_legacy::AudioSystem::DEVICE_OUT_BLUETOOTH_A2DP);
}
