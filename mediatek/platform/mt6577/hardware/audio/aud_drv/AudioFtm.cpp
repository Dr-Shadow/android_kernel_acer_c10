            ...
            char b_headset_out)
{
    ...
    if ((b_phone_mic_sel==MIC1_ON) || (b_phone_mic_sel==MIC2_ON))
    {
        ...
        {
            mAnalog->SetAnaReg(AUDIO_CON1,0x0004,0x003f);//set HPL Gain   //0x000c-->0x0004
            mAnalog->SetAnaReg(AUDIO_CON2,0x0004,0x003f);//set HPR Gain   //0x000c-->0x0004
...
{
	ALOGD("HeadsetMic_Receiver_Loopback, bEnable=%d",bEnable);
        char b_phone_mic_sel  = bEnable;
        char b_headset_mic_in = bHeadsetMic;
        char b_spk_out        = false;
        char b_receiver_out   = true;
